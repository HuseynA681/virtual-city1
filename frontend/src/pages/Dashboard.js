...
export const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      {/* Sidebar */}
      <div className="relative lg:fixed lg:left-0 lg:top-0 lg:h-screen lg:w-64 w-full bg-white/10 backdrop-blur-md border-r border-white/20 p-6 overflow-y-auto">
        <div className="mb-8">
